<template>
    <div ref="root" class="relative">
        <!-- trigger -->
        <button type="button" @click="toggle" @blur="onBlur" class="w-full h-[2.5rem] font-['light'] rounded-[0.5rem] border bg-white
            ...
            <!-- arrow -->
            <SvgIcon width="0.75rem" height="0.75rem" color="#000" icon="arrow-down" :class="isOpen ? 'rotate-180' : 'rotate-0'"
