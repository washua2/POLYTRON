  ...
  <div class="fixed top-0 left-0 right-0 bottom-0 z-[99] flex items-center justify-center bg-[rgba(0,0,0,0.70)]">
    <div class="w-[48.125rem] bg-white rounded-[1rem] overflow-hidden relative">
      ...
      <div class="flex items-center justify-between px-[1.5rem] py-[1.25rem] border-b border-[#EAECEF]">
        ...
        <div
          class="w-[2rem] h-[2rem] flex items-center justify-center cursor-pointer select-none"
          @click="handleClose"
        >
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-x-[0.875rem] gap-y-[1rem]">
              ...
              <div>
                ...
                <input
                  ...
                  class="w-full h-[2.3125rem] font-['light'] flex items-center rounded-[0.5rem]
                         text-[0.875rem] border border-gray-200 px-4 py-[0.5rem] outline-none transition"
                />
              </div>
            ...
            <div class="pt-[1.25rem]">
              ...
              <label class="flex items-center gap-[0.5rem] cursor-pointer select-none">
                ...
                <div class="flex items-center h-[1rem]">
                  ...
                  <span class="text-[#717784] text-[0.75rem] font-['light']">&nbsp;(Continuous Recording)</span>
                </div>
              </label>
        ...
        >
          ...
          <div class="flex flex-col items-center gap-[1rem] mt-[3rem] fhd:mt-[3rem] qhd:mt-[3rem] uhd:mt-[3rem]">
            ...
            <div class="w-[25rem] h-[0.5rem] bg-[#E1E4EA] rounded-full overflow-hidden relative">
              <div
                class="h-[0.5rem] bg-[#1C64F2] absolute left-0 top-0 transition-all"
          ...
          <div class="flex mt-[1.125rem] gap-[0.875rem] flex-wrap">
            <div
              class="w-[22.125rem] h-[6rem] rounded-[0.375rem] pl-[0.75rem] pr-[1.1875rem]
                     pb-[0.75rem] pt-[1.125rem] border-[0.0625rem] border-[#E1E4EA] flex"
              v-for="item in deviceList"
              :key="item.id"
            >
              <div
                class="w-[2.625rem] h-[2.625rem] rounded-full bg-[#ECF3FF]
                       flex-shrink-0 flex items-center justify-center"
              >
                <svg xmlns="http://www.w3.org/2000/svg" width="1.125rem" height="1.125rem" viewBox="0 0 18 18" fill="none">
                  <path
              ...
              <div class="ml-[0.75rem] flex-1 min-w-0">
                <div class="h-[1.5rem] text-[#09090B] text-[0.75rem] font-['medium'] truncate">
                  {{ item.name }}
                </div>
                <div class="w-[9.375rem] text-[#09090B] text-[0.625rem] font-['light'] truncate">
                  {{ item.model }}
                </div>
                <div class="text-[#52525B] text-[0.625rem] font-['light'] tracking-tight">
              ...
              <div class="flex items-center gap-[1.25rem] justify-end self-end ml-[0.75rem]">
                <label class="flex items-center gap-[0.4375rem] cursor-pointer select-none">
                  <input
                    ...
                    class="w-[1rem] h-[1rem] rounded-[0.25rem]
                           border-[0.0625rem] border-[#E1E4EA] ipt outline-none cursor-pointer accent-[#1C64F2]"
                  />
                  <div class="text-[#09090B] text-[0.75rem] font-['medium']">Select</div>
                </label>
                ...
                >
                  ...
                  <div class="text-[#09090B] text-[0.75rem] font-['medium']">Edit</div>
                </div>
              </div>
            </div>
          </div>
      ...
      <!-- footer actions -->
      <div
        class="w-full pr-[1.25rem] py-[1.25rem] flex items-center gap-[1rem] justify-end absolute bottom-0 right-0"
      ...
      >
        <button
          ...
          @click="handleRescan"
        >
          <div class="text-[#09090B] text-[0.875rem] font-['light']">Rescan</div>
        </button>
        ...
        >
          <div class="text-[#fff] text-[0.875rem] font-['light']">Confirm</div>
        </button>
        ...
        <button
          ...
          class="w-[9.375rem] h-[2.5rem] py-[0.5rem] px-[0.75rem] rounded-[0.5rem]
                 border-[0.0625rem] border-[#1C64F2] bg-[#1C64F2] overflow-hidden hover:bg-[#417cf3]"
        >
          <div class="text-[#fff] text-[0.875rem] font-['light']">Add Camera</div>
        </button>
      </div>
    </div>
  </div>
